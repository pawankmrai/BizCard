...
# //ivar named: animationOptions  and of type: UIViewAnimationOptions -- TYPE_NOT_SUPPORTED
# //[encoder encodeType(?):self.animationOptions forKey:kANIMATION_OPTIONS_KEY];
...
- (id)initWithCoder:(NSCoder *)decoder {
  ...
  if (self) {
    ...
    # //ivar named: animationOptions and of type: UIViewAnimationOptions -- TYPE_NOT_SUPPORTED 
    # //[self setAnimationOptions:[decoder decodeType(?)ForKey:kANIMATION_OPTIONS_KEY]];
